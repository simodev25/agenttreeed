...
<process>
  ...
  <step name="2b. Sync project docs mapping (docs/)">
    - API modifiée → `docs/api-contracts-backend.md`
    - Modèle de données modifié → `docs/data-models-backend.md`
    - Architecture modifiée → `docs/architecture.md`, `docs/architecture-backend.md`
    - Pipeline décisionnel modifié → `docs/decision-pipeline.md`
    - Risque/gouvernance modifié → `docs/risk-and-governance.md`
    - Observabilité modifiée → `docs/observability.md`
  </step>
...
<rules>
  ...
  <rule>Ne jamais modifier `.samourai/docai/spec/` directement pour produire/éditer la spec de changement; ce périmètre appartient à `@spec-writer`.</rule>
</rules>
